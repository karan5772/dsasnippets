    ...
    <div className="min-h-screen bg-base-200 flex flex-col items-center justify-center py-10 px-4 md:px-8 w-full">
      ...
      <div className="flex flex-row justify-between items-center w-full mb-6">
        <div className="flex items-center gap-3">
          <Link to={"/home"} className="btn btn-circle btn-ghost">
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              {/* Avatar */}
              <div className="">
                <div className="bg-primary text-white rounded-full w-24 h-24 flex items-center justify-center text-3xl font-bold ring ring-primary ring-offset-base-100 ring-offset-2">
                  {authUser.name
                    ? authUser.name
